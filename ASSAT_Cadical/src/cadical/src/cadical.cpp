...
public:
  ...
  //
  int main (int arg, char **argv ,std::vector<int> *sol);

  int main (char *in ,std::vector<int> *sol);
};
...
// int App::main (int argc, char **argv ,std::vector<int> *sol) {
...
int App::main (char *in ,std::vector<int> *sol) {
...
int cadicallib (char *in ,std::vector<int> *sol) {
  CaDiCaL::App app;
  int res = app.main (in ,sol);
  return res;
}
